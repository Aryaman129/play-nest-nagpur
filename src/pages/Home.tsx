...
const Home = () => {
  ...
  const sports = [
    { name: 'Football', icon: <MdSportsSoccer />, color: 'text-primary' },
    { name: 'Cricket', icon: <MdSportsCricket />, color: 'text-secondary' },
    { name: 'Tennis', icon: <MdSportsTennis />, color: 'text-accent' },
    { name: 'Badminton', icon: <IoTennisball />, color: 'text-primary' },
  ];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        <div 
          ...
          style={{ backgroundImage: `url(${heroTurf})` }}
        >
